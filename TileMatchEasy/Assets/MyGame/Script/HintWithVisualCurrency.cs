...
{
    public class HintWithVisualCurrency : MonoBehaviour, IIAPStoreOffer
    {
        ...
        {
            // 从保存控制器获取计时器状态
            save = SaveController.GetSaveObject<SimpleLongSave>("Hint With Share");
        ...
        private void AddPowerUp()
        {
            ...
            if (canShare)
            {
                CallWechat.ShareApp(() =>
                {
                    ...
                    {
                        PUController.AddPowerUp(PUType.Hint, 1);//添加一个“提示”道具的事例
