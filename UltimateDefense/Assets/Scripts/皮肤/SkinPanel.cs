...
public class SkinPanel : MonoBehaviour
{
    ...
    private UnityAction<Sprite> OnChangeSkin;
    ...
    /// 初始化皮肤面板
    /// </summary>
    public void Init(SkinData skinData,ItemState itemState, UnityAction<Sprite> callback)
    {
        mSkinData = skinData;
    ...
    private void OnSkinClicked(int index)
    {
        ...
        {
            // 保存选择
            mItemState.CurrentSkinID = mSkinData.skins[index].ID;
        }
        OnChangeSkin(mSkinData.skins[index].sprite);
    }
