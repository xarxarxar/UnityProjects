...
public class Role : MonoBehaviour
{
    ...
    public void Init(CardManager cardManager, HookController hookController, RoleData roleData, UnityAction callback=null)
    {
    ...
    {
        if (SpendCoin(_cardManager.SummonCardCoin))
        {
            _hookController.Launch();
