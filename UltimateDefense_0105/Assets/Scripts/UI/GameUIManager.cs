...
public class GameUIManager : ManagerBase<GameUIManager>
{
    ...
    [SerializeField] private ThingItemPanel _thingItemPanel;//物品描述界面
    [SerializeField] private GameObject _blessBuffDescriptionPanel;//对战中，祝福的描述文字面板
    [SerializeField] private Text _blessBuffDescriptionText;//对战中，祝福的描述文字Text
    public BlessPanel _blessPanel;//打开祝福界面
    public BlessBuffShow _currentBlessBuff;
    ...
    /// 显示物品
    /// </summary>
    public void ShowThing(Sprite sprite, string name, string description,bool isPiece=false)
    {
        _thingItemPanel.gameObject.SetActive(true);
        _thingItemPanel.Set(sprite, name, description);//, isPiece);
    }
    ...
    public void ShowBlessBuffDes(string des)
    {
        _blessBuffDescriptionPanel.SetActive(true);
        _blessBuffDescriptionText.text = des;
    }
    ...
    /// </summary>
    /// <param name="des"></param>
    public void HideBlessBuffDes()
    {
        _blessBuffDescriptionPanel.SetActive(false);
    }
    ...
    {
        UploadScore(DataManager.Instance.PlayerInfo.TotalPassCount);
