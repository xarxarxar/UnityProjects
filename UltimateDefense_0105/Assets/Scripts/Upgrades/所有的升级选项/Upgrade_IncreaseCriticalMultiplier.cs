...
public class Upgrade_IncreaseCriticalMultiplier : UpgradeBase
{
    ...
    {
        float[] values = { 0.05f, 0.075f, 0.1f };
    ...
    {
        return TowerManager.Instance.CurrentTower.CriticalMult < 2.5f;//当前炮塔总的暴击伤害不超过250%
    }
    ...
    {
        // 通知 Manager 保存全局加成
        TowerManager.Instance.CritMultBuff.AddChain.AddBuff(new BuffModifier
        {
            Value=_bonus,
            Source=this,
        });
