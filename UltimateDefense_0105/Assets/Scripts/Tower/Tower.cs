...
public abstract class Tower : MonoBehaviour
{
    ...
    private TowerManager _towerManager => TowerManager.Instance;
    ...
    {
        return Mathf.RoundToInt(towerData.BaseDamage * (1f + _towerManager.AtkBuff.AddChain.Result)* _towerManager.AtkBuff.MultiChain.Result);
    }
    /// <summary>
    /// 计算弹夹容量
    /// </summary>
    ...
    {
        return Mathf.RoundToInt((towerData.BaseCap +_towerManager.CapBuff.AddChain.Result)* _towerManager.CapBuff.MultiChain.Result);
    }
    /// <summary>
    /// 计算每秒攻击次数
    /// </summary>
    ...
    {
        return towerData.BaseAtkRate * (1f + _towerManager.AtkRateBuff.AddChain.Result) * _towerManager.AtkRateBuff.MultiChain.Result;
    }
    /// <summary>
    /// 计算暴击概率
    /// </summary>
    ...
    {
        return (towerData.BaseCritProb + _towerManager.CritProbBuff.AddChain.Result)* _towerManager.CritProbBuff.MultiChain.Result;
    }
    /// <summary>
    /// 计算换弹时间
    /// </summary>
    ...
    {
        return towerData.BaseReload * (1f - _towerManager.ReloadBuff.AddChain.Result)* _towerManager.ReloadBuff.MultiChain.Result;
    }
    /// <summary>
    /// 计算暴击伤害倍率
    /// </summary>
    ...
    {
        return (towerData.BaseCritMult + _towerManager.CritMultBuff.AddChain.Result) * _towerManager.CritMultBuff.MultiChain.Result;
    }
