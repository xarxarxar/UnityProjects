...
public class BattleManager : MonoBehaviour
{
    ...
    private int BattleCountNoCollect => DataManager.Instance.PlayerInfo.BattleCountNoCollect;
    #endregion
    ...
    public void EndBattle(bool success)
    {
        ...
        Crystal.OnCrystalDestroyed -= OnCrystalDestroyed;
        DataManager.Instance.PlayerInfo.SetBattleCountNoCollect(BattleCountNoCollect+1);
        Debug.Log("战斗已经结束了");
