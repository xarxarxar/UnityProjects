...
public class ScienceManager : ManagerBase<ScienceManager>
{
    ...
    private int UnlockCount => DataManager.Instance.PlayerInfo.UnlockCount;
    ...
    public int GetUpgradeCountByType(ScienceEffectType type)
    {
        ...
        int fullCycles = UnlockCount / totalCount;
        int remainder = UnlockCount % totalCount;
    ...
    public void UnlockScience(int index)
    {
        ...
        DataManager.Instance.PlayerInfo.SetUnlockCount(UnlockCount+1);
    }
